...
public class MainActivity4 extends AppCompatActivity {
    ...
    private MediaPlayer mediaPlayerClickError;
    private MediaPlayer mediaPlayerClickSwitchTap;
    int lives;
    private int currScore;
    private int wordsAvailable;

    private ArrayList<Integer> ReferringIndicesLA = new ArrayList<Integer>();
    private int currBtnClickedBgColor_ma4;
    private int currBtnClickedTextColor_ma4;
    private int assignedIndex;
    private int currReferredIndexofLA;
    private Animation zoomAnimation_ma4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mediaPlayerClickError = MediaPlayer.create(getApplicationContext(),R.raw.mixkit_click_error_1110);
        mediaPlayerClickSwitchTap = MediaPlayer.create(getApplicationContext(),R.raw.mixkit_click_switch_tap);
        initialiseRandomReferringIndicesStart();
        zoomAnimation_ma4 = AnimationUtils.loadAnimation(getApplicationContext(), R.anim.zoom_animation);
    }
    ...
    private void assigningIndexFn(){
        ...
        if (currReferredIndexofLA<wordsAvailable-1)
        {
            ...
            currBtnClickedBgColor_ma4 = Color.argb(150, r,g,b);
            currBtnClickedTextColor_ma4 = Color.argb(255,255-r, 255-g,255-b);
            onCreateMethodTemp();
        }
        else {
            showGameOverDialog();
    ...
    private void onCreateMethodTemp()
    {
        ...
        resetButton_ma2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mediaPlayerClickSwitchTap.start();
                resetGridViewBtnsTV();
    ...
    private void onTVClickInGrid(int position){
        ...
        else if (currentTextGuessView_la_ma4.size()<assignedWordCurrInput_ma3_larr.size())
        {
            ...
            //btnModel.setBtnBgColor(R.color.btnClicked_ma2);
            btnModel.setBtnBgColor(currBtnClickedBgColor_ma4);
            btnModel.setBtnTextColor(currBtnClickedTextColor_ma4);
